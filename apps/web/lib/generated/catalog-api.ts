...
export type ApprovalType = "PRODUCT_BRIEF" | "CREATIVE_PLAN" | "RESULTS";
...
export type AttemptStatus = "CREATED" | "SUBMITTING" | "SUBMITTED" | "POLLING" | "SUCCEEDED" | "UNKNOWN" | "RETRYABLE_FAILED" | "PERMANENT_FAILED" | "CANCELLED";
...
export type RetentionStatus = "ACTIVE" | "EXPIRING" | "DELETING" | "EXPIRED";
...
export type StepStatus = "PENDING" | "QUEUED" | "CLAIMED" | "RUNNING" | "WAITING_HUMAN" | "SUCCEEDED" | "RETRYABLE_FAILED" | "FAILED" | "CANCELLED";

export type StepType = "VALIDATE_INPUT" | "UNDERSTAND_PRODUCT" | "RETRIEVE_REFERENCES" | "CREATE_PLAN" | "APPROVE_PLAN" | "EXECUTE_TOOL" | "EVALUATE_RESULTS" | "APPROVE_RESULTS" | "EXPORT";
...
export interface WorkflowAttemptResponse {
  id: string;
  step_id: string;
  attempt_number: number;
...
export interface WorkflowResponse {
  ...
  attempts?: Array<WorkflowAttemptResponse>;
